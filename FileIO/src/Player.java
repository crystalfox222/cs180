...
public class Player {
    ...
    public Player (String fn, String ln, String pos, int shoot, int pass, int lay, int athl, int def, int reb, ArrayList<String> skill) throws UnsupportedRosterException{
        this.firstName = fn;
        this.lastName = ln;
        this.position = pos;
