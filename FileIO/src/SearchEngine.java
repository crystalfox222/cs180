...
public class SearchEngine {
        ...
        public static PlayerList readFile(String fileName) throws FileNotFoundException, IOException, UnsupportedRosterException{
                ...
                while (read != null) {
                        ...
                        Player player = new Player(firstName, lastName, position, shooting, passing, layup, athletics, defense, rebound, skills);
                        playlist = new ArrayList();
                        list = new PlayerList(playlist);
        ...
        public static void writeFile(ArrayList<Player> startup, String output) throws IOException {
                ...
                for (a = 0; a < startup.size(); a++) {
                        ...
                        pw.append(startup.get(a).getFirstName() + " " + startup.get(a).getLastName() + " " + startup.get(a).getPosition() + " " + startup.get(a).getTotalAttribute());
                }
                pw.close();
